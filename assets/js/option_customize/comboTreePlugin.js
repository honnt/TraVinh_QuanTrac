;(function ($, window, document, undefined) {
    ...
    ComboTree.prototype.init = function () {
        ...
        this.comboTreeId = 'comboTree_select_box';
    ...
    ComboTree.prototype.createSourceSubItemsHTML = function (subItems, parentId) {
        var subItemsHtml = '<UL id="' + this.comboTreeId +
            ...
            /***
             Xóa this.options.collapse
             ((this.options.collapse && parentId) ? 'display:none;' : '')  + '">'
             ***/
            ((parentId > 0) ? 'display:none;' : '') + '">';
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (isThereSubs)
            itemHtml += '<span class="comboTreeParentPlus">' +
                (this.options.collapse ?
                    '<span class="mdi mdi-chevron-right-circle-outline"></span>' :
                    '<span class="mdi mdi-chevron-down-circle-outline"></span>') + '</span>';
        // itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '+' : '&minus;') +
        // '</span>';
